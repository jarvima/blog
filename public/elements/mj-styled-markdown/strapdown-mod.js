...
// specifically
// https://github.com/arturadib/strapdown/tree/gh-pages/v/0.2

var mj = window.mj || {};
mj.styleMarkdown = function(element, markdown) {
  ...
  element.querySelector('#content').innerHTML = html;

  // Prettify
  var codeEls = element.getElementsByTagName('code');
  ...
  // Style tables
  var tableEls = element.getElementsByTagName('table');
